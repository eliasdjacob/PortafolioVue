...
const habilidades = ref([
  {
    ...
    habilidades: [
      ...
      { id: 5, nombre: "MySQL", nivel: "Intermedio", icono: img5 },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    habilidades: [
      ...
      { id: 3, nombre: "Cypress", nivel: "Básico", icono: img13 },
  ...
  },
  {
    ...
    habilidades: [
      ...
      { id: 3, nombre: "PostgreSQL", nivel: "Básico", icono: img18 },
    ],
  },
  {
    id: 5,
...
<template>
  <div class="skills-contenedor">
    <div
      ...
      :key="habilidad.id"
      class="skills-categoria"
    >
      <h3>{{ habilidad.nombre }}</h3>
      <ul class="skills">
        <li
          v-for="habilidad in habilidad.habilidades"
          :key="habilidad.id"
          class="skill"
        >
